  ...
  return (
    <div className="page-shell page-shell-narrow max-w-3xl space-y-6">
      ...
      <article className="card radar-prose p-6 md:p-10">
        ...
        <p>O pipeline (fontes oficiais → normalização → cruzamento geográfico → regras → confidence → validação → publicação) roda automaticamente às <strong>08:00</strong> e <strong>18:00</strong> (America/Sao_Paulo). A cada execução são detectados novos registros e alterações, os scores são recalculados, oportunidades que deixam de cumprir critérios são <strong>arquivadas</strong> (nunca apagadas silenciosamente), o sitemap é atualizado e o histórico antes/depois é registrado para auditoria.</p>
